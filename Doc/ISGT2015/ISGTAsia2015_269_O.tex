...
\centering
	...
	\centering
	\includegraphics[scale=0.7, clip=true, trim=0cm 8.1cm 5cm 0]{figures/Wholesale_d.pdf}
	\hspace{-1.2cm}\includegraphics[scale=0.7, clip=true, trim=0cm 7.5cm 5cm 0.6cm]{figures/Wholesale_d.pdf}
	\hspace{-0.5cm}\includegraphics[scale=0.7, clip=true, trim=0cm 6.9cm 5cm 1.2cm]{figures/Wholesale_d.pdf}
	\includegraphics[scale=0.7, clip=true, trim=5cm 8.1cm 0cm 0]{figures/Wholesale_d.pdf}
	\includegraphics[scale=0.7, clip=true, trim=5cm 7.5cm 0cm 0.6cm]{figures/Wholesale_d.pdf}
	\includegraphics[scale=0.7, clip=true, trim=5cm 6.9cm 0cm 1.2cm]{figures/Wholesale_d.pdf}	
	\end{subfigure}

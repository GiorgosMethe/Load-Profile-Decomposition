...
\caption{\textbf{Left}: probability density function $p_{\delta}$ for the duration (hours) of processes. \textbf{Right}: probability density function $p_k$ over consumption rates (kW) of the processes.}
